...
import 'package:example/cinema/plubic/accueil.dart';
    ...
    await http.post(url, body: userData,headers: {
       'Content-type': 'application/json',
        ...
        if(resp.headers['authorization']!=null){
          ...
          Navigator.of(_context).push(MaterialPageRoute(builder:(context)=>new CinemaApp(username,password,Authservice.token)));
          print(reponse);
        }else{
